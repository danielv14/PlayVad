...
<div class="fullwidth-netflix subtle-shadow"></div>
...
<div class="wrapper fullscreen-div space-above space-below">
  ...
  <div class="article-aside right">
    <aside>
      ...
      <h3 class="header-space-above-small"><a class="link" href="#utbud">Utbud</a></h3>
      <h3 class="header-space-above-small"><a class="link" href="#plattformar">Plattformar</a></h3>
      <h3 class="header-space-above-small"><a class="link" href="#kostnad">Kostnad och bindningstid</a></h3>
      <h3 class="header-space-above-small"><a class="link" href="#streamare">Aktiva streamare</a></h3>
      <h3 class="header-space-above-small"><a class="link" href="#individanpassning">Individanpassning</a></h3>
    </aside>
  </div>
  ...
  <div class="article-content space-below">
    <article>
      ...
      <h3 class="special-font">Exempel på egenproducerade dokumentärer</h3>
      <ul>
      <li>Virunga</li>
  ...
  <div id="plattformar" class="article-content-fullscreen">
    <article>
      <h2 class="special-font header-big header-space-above-normal header-center">Netflix finns på följade plattformar</h2>
      <ul class="list-col">
  ...
  <div class="article-content space-above">
    <article>
      ...
      prenumerationen.</p>
      <h2 class="special-font">Kostnad</h2>
      <p>Netflix har 3 olika abonnemang som innebär lite olika saker. Det första abonnemanget kostar 79kr/månad och innebär att det går att titta på en skärm åt gången i standardupplösning. &ldquo;Mellanabonnemanget&rdquo; kostar 89kr/månad och med detta abonnemang kan man titta på 2 skärmar samtidigt i HD kvalité, om ens Internet och TV klarar av det. Det tredje och sista abonnemanget kostar 119kr/månad där det går att titta på upp till 4 skärmar samtidigt. Utöver HD kvalité har även detta abonnemang stöd för så kallad <a href="https://sv.wikipedia.org/wiki/Ultra_High_Definition_Television">Ultra HD</a>.</p>
      ...
      <h2 class="special-font">Bindningstid</h2>
      ...
      <h2 id="profiler" class="special-font">Profiler</h2>
      ...
      <h2 class="special-font">Min lista</h2>
